ServerEvents.recipes(e => {
    ...
    e.recipes.vintageimprovements.centrifugation(['2x minecraft:gold_nugget', 'thermal:silver_nugget', 'kubejs:tellurium_dust', '2x minecraft:clay'], Fluid.of('kubejs:acidic_platinum_mud', 1000), 150, 64).id('ico:recycle_platinum_mud')
